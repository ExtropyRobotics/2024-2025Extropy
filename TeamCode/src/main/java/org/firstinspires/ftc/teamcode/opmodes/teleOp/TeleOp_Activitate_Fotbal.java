...
public class TeleOp_Activitate_Fotbal extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            motorStangaF.setPower(+ sticklefty + stickleftx );
            motorDreaptaF.setPower(+ sticklefty - stickleftx );
            motorDreaptaS.setPower(+ sticklefty + stickleftx );
            motorStangaS.setPower(+ sticklefty - stickleftx );
